...
$lang['delete_addon'] = 'Jeste li sigurni da želite Are you sure you want to DEINSTALIRATI ovaj Add-on? Odabir je trajan i ne može biti poništen.';
$lang['delete_blog_entry'] = 'Jeste li sigurni da želite IZBRISATI obaj upis u blog? Odabir je trajan i ne može biti poništen.';
$lang['addon_name_invalid'] = 'IME ADD-ONa je nepravilno - INJECTION POKUŠAJ JE ZAUSTAVLJEN';
$lang['maintenance_mode'] = 'Mod održavanja';
$lang['maintenance_mode_desc'] = 'Pokreni Open-Realty u modu održavanja? Svi korisnici (agenti, članovi i ostali posjetitelji) će vidjeti samo stranicu s "mod održavanja" ("maintenance_mode.html" predložak). Samo "admin" (korisničko ime) ako je LOGIRAN će moći "vidjeti" web stranicu kao i obično.';
